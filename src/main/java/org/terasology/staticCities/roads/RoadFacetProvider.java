...
public class RoadFacetProvider implements FacetProvider {
    ...
    public void process(GeneratingRegion region) {
        ...
        GeneralPathFinder<ImmutableVector2i> pathFinder = new GeneralPathFinder<>(e -> sourceMap.getOrDefault(e,
        ...
        for (Road road : candidates) {
            ...
            if (!optPath.isPresent() || optPath.get().getLength() > 1.25 * road.getLength()) {
                Edge<ImmutableVector2i> e = new DefaultEdge<ImmutableVector2i>(road.getEnd0(), road.getEnd1(),
                        road.getLength());
    ...
    private Optional<Road> tryBuild(BaseVector2i posA, BaseVector2i posB, float width,
    ...
    private Optional<Road> tryDirect(BaseVector2i posA, BaseVector2i posB, float width,
                                     BuildableTerrainFacet terrainFacet) {
    ...
    private Optional<Road> tryPathfinder(BaseVector2i posA, BaseVector2i posB, float width,
                                         BuildableTerrainFacet terrainFacet) {
