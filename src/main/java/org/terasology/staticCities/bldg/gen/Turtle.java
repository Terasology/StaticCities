...
public class Turtle {
     ...
     */
    public BlockArea rect(int right, int forward, int width, int len) {
        Vector2ic dir = orient.direction();
     ...
     * @return the rectangle
     */
    public BlockArea rectCentered(int forward, int width, int len) {
     ...
     */
    public BlockArea adjustRect(BlockAreac rc, int left, int back, int right, int forward) {
